...
class CardsList extends React.Component {
  ...
  handleImgChange = event => this.setState({ img: event.target.value })

  handleGroupChange = event => this.setState({ group: event.target.value })
            ...
            <div className="modal">
              ...
              <div className="actions">
                ...
                <input
                  type="text"
                  name="img"
                  placeholder="Ingrese un link a la imagen del año"
                  onChange={this.handleImgChange}
                />
                <input
                  type="text"
                  name="group"
                  placeholder="Ingrese el grupo al que pertenece esta carta"
