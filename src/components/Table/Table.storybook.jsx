...
storiesOf('Table', module)
  ...
  .add('Tablero inicial del juego, dos jugadores', () => {
    const playedCards = [
      {
        name: 'Revolucion francesa',
        year: 1789,
        image: 'https://bit.ly/2IQDdoX'
      }
    ]
    const playerHand = [
      {
        _id: 1,
        name: 'Revolución Rusa',
        year: 1400,
        image: 'https://bit.ly/2IQDdoX'
      },
      {
      ...
      {
        _id: 4,
        name: 'Invencion de la radio',
        year: 1400,
        image: 'https://bit.ly/2IQDdoX'
      },
      {
        _id: 5,
        name: 'Invencion del automovil',
        year: 1400,
        image: 'https://bit.ly/2IQDdoX'
      },
      {
  ...
  .add('Table juego avanzado', () => {
    const timeline = [
      ...
      {
        _id: 6,
        name: 'Inicio primera guerra mundial',
        year: 1400,
        image: 'https://bit.ly/2IQDdoX'
      },
      {
        _id: 7,
        name: 'Caida del muro de Berlin',
        year: 1400,
        image: 'https://bit.ly/2IQDdoX'
      },
      {
        _id: 8,
        name: 'Caida del imperio romano',
        year: 1400,
        image: 'https://bit.ly/2IQDdoX'
      },
      {
      ...
      {
        _id: 10,
        name: 'Invencion de la penicilina',
        year: 1400,
        image: 'https://bit.ly/2IQDdoX'
      }
    ]
